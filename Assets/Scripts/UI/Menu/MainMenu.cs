...
public class MainMenu : MonoBehaviour
{
    ...
    [Inject]
    private void InputManagerAndSceneController(InputManager inputManager, SceneController sceneController, SoundManager soundManager, MenuToggleManager menuToggleManager, LocalizationManager localizationManager)
    {
