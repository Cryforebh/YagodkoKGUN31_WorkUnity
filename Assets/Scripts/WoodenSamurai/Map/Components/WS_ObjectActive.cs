...
public class WS_ObjectActive : MonoBehaviour, IPointerEnterHandler, IPointerClickHandler, IPointerExitHandler
{
    ...
    [SerializeField, Tooltip("Какой модификатор применить?")] private WS_EnumModifier _modifier = WS_EnumModifier.None;
    ...
    private void Click()
    {
        ...
        switch (_modifier)
        {
            ...
            case WS_EnumModifier.Drink:
                _allCell.SetModifierAllUnits(WS_EnumModifier.Drink, true, _player);
                _playerManager.OnActivePlayerChanged += RemoveMofifire;
                break;
            case WS_EnumModifier.UpHelth:
                _allCell.SetModifierAllUnits(WS_EnumModifier.UpHelth, true, _player);
                break;
            default:
                break;
        }
    ...
    private void ModifireSakeEnd(EnumPlayers players)
    {
        ...
        _allCell.SetModifierAllUnits(WS_EnumModifier.Drink, false, _player);
